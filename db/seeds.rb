...
question3 = Question.create! :title => "Routing", :body => "where is the routes.rb file located? ", :user_id => user.id
question4 = Question.create! :title => "Resume", :body => "is my previous experience relevant now? ", :user_id => user.id
question5 = Question.create! :title => "Success", :body => "What should i do prior to starting bootcamp to have the best chance for success ", :user_id => user.id
...
tag1 = Tag.create(name: 'bootcamp prep')
tag2 = Tag.create(name: 'interviews')
tag3 = Tag.create(name: 'javascript')
tag4 = Tag.create(name: 'rails')
tag5 = Tag.create(name: 'ruby')
tag6 = Tag.create(name: 'css')
tag7 = Tag.create(name: 'html')
tag8 = Tag.create(name: 'homework help')
