...
# Example Answers
answer1 = question1.answers.create! :question_id => 1, :content => 'Put down the computer and exercise', :user_id => user2.id
answer2 = question1.answers.create! :question_id => 1, :content => 'Suck it up buttercup', :user_id => user3.id
...
answer4 = question2.answers.create! :question_id => 2, :content => 'Who knows ask Oggi ', :user_id => user3.id
answer5 = question3.answers.create! :question_id => 3, :content => 'in config file ', :user_id => user2.id
answer6 = question3.answers.create! :question_id => 3, :content => 'type ctrl T in atom and search ', :user_id => user.id
answer7 = question4.answers.create! :question_id => 4, :content => 'yes but keep it short ', :user_id => user2.id
answer8 = question4.answers.create! :question_id => 4, :content => 'no the past is prologue ', :user_id => user3.id
answer9 = question5.answers.create! :question_id => 5, :content => 'do CodeAcaddemy tutorials ', :user_id => user.id
answer10 = question5.answers.create! :question_id => 5, :content => 'Learn to type well ', :user_id => user3.id
